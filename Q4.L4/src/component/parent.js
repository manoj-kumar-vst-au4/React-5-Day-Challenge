            ...
            <table  className="table ">
             ...
             <tbody >
               {(this.state.option==="All"||this.state.option==="")?this.state.list.map((item, index)=>{
                 return (
                 <tr key={index} className={(item.user==="Manoj"?"bg-danger":null)||(item.user==="Sumit"?"bg-primary":null)||(item.user==="Sunil"?"bg-dark text-white":null)||(item.user==="Ajay"?"bg-warning":null)}>
                   <td>{item.user}</td>
                   <td>{item.input}</td>
                 </tr>
                 )
